    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                {{ __('Modifier l\'entreprise') }}: {{ $company->name }}
            </h2>
                    ...
                    <form method="POST" action="{{ route('companies.update', $company->id) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="address" name="address"
                                      class="block mt-1 w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 shadow-sm">{{ old('address', $company->address) }}</textarea>
